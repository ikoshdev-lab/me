...
if (contactForm) {
    contactForm.addEventListener('submit', async (e) => {
        ...
        const API_URL = isLocal ? 'http://localhost:5000/api/contact' : 'https://portfolio-backend-xxxx.onrender.com/api/contact'; // Render'dan olgan manzilingizni shu yerga qo'ying
